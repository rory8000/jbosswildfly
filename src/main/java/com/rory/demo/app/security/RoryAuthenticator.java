package com.rory.demo.app.security;
...
public final class RoryAuthenticator {

    private static RoryAuthenticator authenticator = null;
    ...
    private RoryAuthenticator() {
         ...
         */
        serviceKeysStorage.put("f80ebc87-ad5c-4b29-9366-5359768df5a1", "rory");
        serviceKeysStorage.put("3b91cab8-926f-49b6-ba00-920bcf934c2a", "username2");
    }

    public static RoryAuthenticator getInstance() {
        if (authenticator == null) {
            authenticator = new RoryAuthenticator();
        }
